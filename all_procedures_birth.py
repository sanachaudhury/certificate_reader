...
def everything(directory, first, last):
    ...
    for file in b:
        ...
        data = np.array([['Column 0', 'Column 1', 'Column 2', 'Column 3', 'Column 4', 'Column 5', 'Column 6', 'Column 7', 'Column 8', 'Column 9', 'Column 10'], list])
        df = pd.DataFrame(data=data[1:,0:])
        append_df_to_excel('well_im_trying.xlsx', df)
